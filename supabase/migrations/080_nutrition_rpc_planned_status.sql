-- =============================================================================
-- Migration 080: Update create_nutrition_plan_atomic to support planned status.
-- Future effective dates insert as 'planned' (active plan untouched).
-- Today/past dates archive active + any orphaned planned, insert as 'active'.
-- =============================================================================
