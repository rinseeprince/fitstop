...
--
-- Timestamp-prefixed, not 138_: the newest applied remote version is
-- 20260804093925, and "138" sorts BEFORE it ('1' < '2'), so `supabase db push`
-- would refuse it as an out-of-order migration and demand --include-all. The
-- 3-digit era ended at 137.
--
