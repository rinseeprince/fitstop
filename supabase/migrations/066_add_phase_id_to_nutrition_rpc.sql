-- =============================================================================
-- Migration 066: Add p_phase_id parameter to create_nutrition_plan_atomic RPC
-- Allows linking a nutrition plan to a roadmap phase at creation time.
-- Backward compatible: p_phase_id defaults to NULL.
-- =============================================================================
...
BEGIN
  ...
  INSERT INTO nutrition_plans (
    ...
    p_regeneration_reason, p_phase_id
  )
