-- =============================================================================
-- Migration 086: Add p_saved_plan_id parameter to create_training_plan_atomic.
-- Allows placement from coach library to pass saved_plan_id through to the
-- new training_plans row. Backwards-compatible (defaults to NULL).
-- =============================================================================
