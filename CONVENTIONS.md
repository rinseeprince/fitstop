  ...
  **Denormalisation is allowed only when named and documented.** Submit-time snapshot columns
  ...
  save, and re-recorded by the coach's replacement of a logged today) and the copy-based library
  placement are sanctioned because
