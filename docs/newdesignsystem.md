...
- **The Sets cell** is `MONO_CELL_CLASS` ink, `min-w-[200px] whitespace-normal` so a long session wraps instead of widening the table: `100 × 8 · 102.5 × 8`, `12 · 11 · 10`, `60 × 40 m`, `5 km` (a session of one piece: its time is the Time figure), `10 km in 52:00` (a piece among other sets), `6 × 800 m: 2:52 · 2:50 · 2:48`, `1:30 · 1:20`.
