...
- **The Sets cell** is `MONO_CELL_CLASS` ink, `min-w-[200px] whitespace-normal` so a long session wraps instead of widening the table: `100 × 8 · 102.5 × 8`, `12 · 11 · 10`, `60 × 40 m`, `5 km in 24:10`, `6 × 800 m: 2:52 · 2:50 · 2:48`, `1:30 · 1:20`.
- **Figure cells** are `MONO_CELL_CLASS` ink in the logged-workout table's grammar ("129.8", "102.5 × 8", "4:50 /km", "5 km", "Z3", a bare number under its heading). The main figure carries its change after it, `ml-1.5 text-[11px]` in the check-in review's delta colours — `#0d9488` better, `#d97706` worse, `#93b0b4` level — "+3.1", "-0:10". Nothing recorded is a `#c2d0cc` dash.
