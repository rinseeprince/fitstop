...
**Owner's answers** (fill in before commit 2; D9 before commit 4): D1 — · D2 — · D3 — · D4 (revised) — · D5 — · D6 — · D7 — · D8 — · D9 — · D10 — add (2026-09-02) · D11 — derived; coach entries and check-in submissions excluded (2026-09-02)
...
**STATUS: NOT STARTED. Blocked on D1–D8 (D10 is already in the table definition).**
...
- Wire proofs diffed at the end; a §2-rule-7 note in the commit body per route. Every wire must be byte-identical; a difference is a defect to fix, never a fixture to update.
...
strip and the energy pair; remove then re-log the same value).
```
