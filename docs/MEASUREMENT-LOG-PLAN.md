...
*Rules 1–3 are SUPERSEDED for edits by commit 8 (owner, 2026-09-03): a reading is edited IN PLACE — edit replaces the row's value, add adds a row, editing a check-in's reading edits its own row with its stamp — and the day's value is the reading written or edited last (D23). What survives of rule 1: nothing deletes a row, and every UPDATE the table sees is one of three RPCs (update, void, restore).*
