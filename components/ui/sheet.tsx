    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          // rgba(13,148,136,0.08)) and which `shadow-lg` above already makes
          // unnecessary — spacing and shadow separate, not rules. It was invisible
          // for years because every sheet had a light body at that edge; the client
          // details sheet is the first with a dark hero pressed against it, where it
          // read as a white hairline. Two sheets had already patched it out locally
          // with `border-0`. A sheet that genuinely wants an edge asks for it at the
          // call site, in the system colour (see calendar/library-panel.tsx).
