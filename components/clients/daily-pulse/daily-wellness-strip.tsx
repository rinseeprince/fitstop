...
export function DailyWellnessStrip({ clientId }: DailyWellnessStripProps) {
    ...
    return (
      <div>
        ...
        <div className="bg-white rounded-[6px] p-8 text-center">
          <p className="text-[13px] font-medium text-[#5a7d82]">No daily wellness data yet</p>
          <p className="text-[12px] text-[#93b0b4] mt-1">
  ...
  return (
    <div className="relative">
      ...
      {/* Adherence Dot Rows */}
      <div className="space-y-4 pt-4 border-t border-[rgba(13,148,136,0.08)]">
        <AdherenceDotRow
          logs={logs}
          type="nutrition"
        ...
        {selectedLog && (
          <>
            <motion.div
              ...
              className="fixed inset-0 bg-black/5 z-[5] cursor-pointer"
