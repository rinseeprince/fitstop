...
Write in British English. Use plain text only: no markdown, no asterisks, no bullet characters, no headings, and no em dashes (use hyphens or rephrase). Be concise and specific, lead with what matters most, and use the client's own words from their notes where relevant. Frame nutrition through a weekly lens, not a daily one.
